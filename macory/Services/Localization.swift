...
struct Localization {
    ...
    static let strings: [String: LocalizedString] = [
        ...
        "menu_about": LocalizedString(
            ...
            de: "Über Macory",
            es: "Acerca de Macory",
            fr: "À propos de Macory",
            zh: "关于 Macory",
            ja: "Macory について",
            ko: "Macory 정보",
            ru: "О приложении Macory",
            pt: "Sobre o Macory",
            it: "Informazioni su Macory"
        ),
        ...
        "settings_title": LocalizedString(
            en: "Macory Settings",
            de: "Macory Einstellungen",
            es: "Ajustes de Macory",
            fr: "Réglages Macory",
            zh: "Macory 设置",
            ja: "Macory 設定",
            ko: "Macory 설정",
            ru: "Настройки Macory",
            pt: "Configurações do Macory",
            it: "Impostazioni Macory"
        ),
        ...
        "keychain_access_message": LocalizedString(
            en: "Macory needs access to the Keychain to store the encryption key securely. Encryption will be disabled for now. You can enable it anytime in the settings.",
            de: "Macory benötigt Zugriff auf den Schlüsselbund, um den Verschlüsselungsschlüssel sicher zu speichern. Die Verschlüsselung wird vorerst deaktiviert. Sie können sie jederzeit in den Einstellungen aktivieren.",
            es: "Macory necesita acceso al llavero para guardar la clave de seguridad. La encriptación se desactivará por ahora.",
            fr: "Macory a besoin d'accéder au trousseau pour stocker la clé de sécurité. Le chiffrement est désactivé pour l'instant.",
            zh: "Macory 需要访问钥匙串以存储密钥。加密暂时禁用。",
            ja: "Macory はキーを保存するためにキーチェーンへのアクセスを必要とします。暗号化は一時的に無効になります。",
            ko: "Macory는 키를 저장하기 위해 키체인 접근이 필요합니다. 암호화는 현재 비활성화됩니다.",
            ru: "Macory нужен доступ к связке ключей. Шифрование пока отключено.",
            pt: "Macory precisa de acesso às Chaves. A criptografia será desativada por enquanto.",
            it: "Macory necessita accesso al portachiavi. Crittografia disabilitata per ora."
        ),
        ...
        "encrypt_opt_in_message": LocalizedString(
            en: "Macory can encrypt your clipboard history to protect sensitive information like passwords and credit cards.\n\nEncryption is optional but recommended for enhanced security. You can change this later in Settings.",
            de: "Macory kann Ihren Zwischenablage-Verlauf verschlüsseln, um sensible Informationen wie Passwörter und Kreditkarten zu schützen.\n\nVerschlüsselung ist optional, aber für erhöhte Sicherheit empfohlen. Sie können dies später in den Einstellungen ändern.",
            es: "Macory puede encriptar tu historial para proteger información sensible.\n\nLa encriptación es opcional pero recomendada.",
            fr: "Macory peut chiffrer votre historique pour protéger les informations sensibles.\n\nLe chiffrement est optionnel mais recommandé.",
            zh: "Macory 可以加密您的历史记录以保护敏感信息。\n\n加密是可选的，但建议启用。",
            ja: "Macory は履歴を暗号化して機密情報を保護できます。\n\n暗号化はオプションですが、推奨されます。",
            ko: "Macory는 기록을 암호화하여 정보를 보호할 수 있습니다.\n\n암호화는 선택 사항이지만 권장됩니다.",
            ru: "Macory может зашифровать историю для защиты данных.\n\nШифрование рекомендуется.",
            pt: "Macory pode criptografar seu histórico para proteger informações.\n\nA criptografia é recomendada.",
            it: "Macory può criptare la cronologia per proteggere i dati.\n\nLa crittografia è consigliata."
        ),
        ...
        "accessibility_info_message": LocalizedString(
            en: "Macory needs Accessibility permission for automatic paste functionality.\n\nPlease grant permission in the next dialog.",
            de: "Macory benötigt Zugriff auf die Bedienungshilfen für die automatische Einfügefunktion.\n\nBitte gewähren Sie Zugriff im nächsten Dialog.",
            es: "Macory necesita permiso de accesibilidad para pegar automáticamente.\n\nPor favor, concede el permiso.",
            fr: "Macory a besoin de la permission d'accessibilité pour le collage automatique.\n\nVeuillez accorder la permission.",
            zh: "Macory 需要辅助功能权限以自动粘贴。\n\n请授予权限。",
            ja: "Macory は自動貼り付けのためにアクセシビリティ権限を必要とします。\n\n許可してください。",
            ko: "Macory는 자동 붙여넣기를 위해 권한이 필요합니다.\n\n권한을 허용해 주세요.",
            ru: "Macory нужен доступ для авто-вставки.\n\nПожалуйста, предоставьте доступ.",
            pt: "Macory precisa de permissão para colagem automática.\n\nPor favor, conceda.",
            it: "Macory necessita del permesso per l'incolla automatico.\n\nPer favore, concedi il permesso."
        )
    ]
}
